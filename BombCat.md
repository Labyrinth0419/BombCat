...
- [2.基本逻辑](#2基本逻辑)
  - [2.1.基本框架](#21基本框架)
  - [2.2.`Card`类的要求](#22card类的要求)
  - [2.3.`Player`类的要求](#23player类的要求)
  - [2.4.`Game`类的要求](#24game类的要求)
- [3.目前任务（2024/6/24 - 2024/6/30）](#3目前任务2024624---2024630)
- [4.代码规范](#4代码规范)
  - [4.1.命名规范](#41命名规范)
    - [举例：](#举例)
  - [4.2.示例代码](#42示例代码)
    - [一些具体的注意点](#一些具体的注意点)
    - [例如下示例中，`DIYClass` 的用法](#例如下示例中diyclass-的用法)
  - [4.3.函数头格式](#43函数头格式)
    - [例如：](#例如)
  - [4.4.函数长度要求](#44函数长度要求)
- [5.卡牌描述](#5卡牌描述)
  ...
  - [扩展包A 20张牌](#扩展包a-20张牌)
  - [扩展包B 14张](#扩展包b-14张)
  - [扩展包C 20张牌（缺）](#扩展包c-20张牌缺)

<!-- vscode-markdown-toc-config
	numbering=false
	autoSave=true
	/vscode-markdown-toc-config -->
<!-- /vscode-markdown-toc --># BombCat Project
...
### <a name='Player'></a>2.3.`Player`类的要求
...
## <a name='-1'></a>3.目前任务（2024/6/24 - 2024/6/30）
...
#### <a name='DIYClass'></a>例如下示例中，`DIYClass` 的用法
```cpp
